...
public class Ex05_ChickenMenu {
	...
	public static void printMenu() {
		...
		System.out.println("1. 교촌 치킨 - 허니콤보");
		...
		System.out.println("7. BBQ - 황금올리브 치킨");
	...
	public static String selectMenu(int menuNo) {
		String menuName = "";
		switch (menuNo) {
		case 1: menuName = "교촌 치킨 - 허니콤보"; break;
		case 2: menuName = "처갓집 - 양념 치킨"; break;
		case 3: menuName = "굿후렌드 - 후라이드 치킨"; break;
		case 4: menuName = "보드람 - 후라이드 치킨"; break;
		case 5: menuName = "굽네치킨 - 볼케이노"; break;
		case 6: menuName = "BBQ - 황금올리브 치킨"; break;
